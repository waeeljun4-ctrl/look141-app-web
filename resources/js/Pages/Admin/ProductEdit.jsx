                            ...
                            <div className="bg-white rounded-2xl border border-cream-3 p-4 space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <Input label="اسم المنتج" value={data.name}
                                        ...
                                        error={errors.name} placeholder="طقم رياضي أديداس" />
                            ...
                            <div className="bg-white rounded-2xl border border-cream-3 p-4 space-y-3">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <Input label="السعر (₪)" type="number" min="0" step="0.01"
                                        ...
                                        error={errors.price} placeholder="180" />
                                ...
                                {data.variants.map((v, i) => (
                                    <div key={i} className="grid grid-cols-12 gap-2 items-end border-b border-cream-3 pb-3 last:border-0 last:pb-0">
                                        <div className="col-span-4">
                                            <Input label="المقاس" value={v.size} onChange={e => updateVariant(i, 'size', e.target.value)} placeholder="M" />
                                        </div>
                                        <div className="col-span-4">
                                            <Input label="اللون" value={v.color} onChange={e => updateVariant(i, 'color', e.target.value)} placeholder="أسود" />
                                        </div>
